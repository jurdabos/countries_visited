...
- Load predefined palettes from `palettes.json` fileciteturn0file0.
...
*All datasets use gzip compression level 4.*
...
| Serialisation | **HDF5** via h5py | Hierarchical, efficient      | Parquet export (arrow)         |
